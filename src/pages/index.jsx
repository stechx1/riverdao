  ...
  return (
    <div className='container mx-auto text-center my-12'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-x-6 my-10'>
        ...
        <TierCard imgSrc={"/images/tier-1.png"} tierName="Founding Member Tier 1" amount="100" points={tier1Points} />
        <TierCard imgSrc={"/images/tier-2.png"} tierName="Founding Member Tier 2" amount="250" points={tier2Points} />
        <TierCard imgSrc={"/images/tier-3.png"} tierName="Founding Member Tier 3" amount="500" points={tier3Points} />
      </div>
    </div>
  );
}
